    ...
    return (
      <Surface title="Posts">
        <div className="flex flex-col gap-5">
          ...
          <div>
            <span className={'text-xl font-bold text-gray-900 dark:text-white'}>Adicionar comentário</span>
            <NewCommentForm postId={numericId} />
          </div>

          <div>
            <span className="text-xl font-bold text-gray-900 dark:text-white">Comentários</span>
            <div className="flex flex-col gap-3">
              {post.comments && post.comments.length > 0 ? (
                ...
                <p className='text-gray-900 dark:text-white'>Nenhum comentário encontrado.</p>
              )}
            </div>
          </div>
        </div>
